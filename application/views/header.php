...
<html lang="es" dir="ltr">
  ...
  <body>
    <div class="text-center">
      <!-- <img src="<?php echo base_url(); ?>/assets/images/logo2.png" alt="logo2" height="100px" > -->
      <!-- width="200px" -->
    </div>
    <nav class="navbar navbar-inverse">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo site_url(); ?>">RESERVAS</a>
        </div>
